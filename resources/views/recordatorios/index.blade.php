...
@section('content')
    ...
    <div class="modal" id="crud_modal" data-backdrop="static" >
        ...
        <div class="modal-content">
            ...
            <form name="frmRecordatorio" id="frmRecordatorio" class="form-horizontal">
            <!-- Modal body -->
        ...
        <div class="col-md-12 col-lg-12">
            ...
            <div class="block ">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Recordatorios</h3>
...
<script type="text/javascript">
    ...
    $('body').on('click', '#gridEdit', function() {
        ...
        var id = $(this).data('id');
			...
			$.get('/recordatorios/edit/'+ id, function(data) {
    ...
    $('body').on('click', '#gridDetail', function() {
        ...
        var id = $(this).data('id');
			...
			$.get('recordatorios/'+ id, function(data) {
    ...
    if ($("#frmRecordatorio").length > 0) {
		$("#frmRecordatorio").validate({
			rules: {
			...
			submitHandler: function(form) {
                ...
                $.ajax({
					data: $('#frmRecordatorio').serialize(),
					url: "/recordatorios/store",
                    type: "POST",
                    global: true,
					dataType: 'json',
					success: function(data) {
