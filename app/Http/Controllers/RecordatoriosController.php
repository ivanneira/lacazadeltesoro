...
class RecordatoriosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            //     $recordatorio  = Recordatorios::where($where)->first();
            //     $image = ($request->fotobase64 !="" ) ? $request->fotobase64 : $recordatorio->foto;
            // }
            // else
            // {
            ...
            $recordatorio = Recordatorios::updateOrCreate(
                ['id' => $request->id ],
                [
            ...
            DB::commit();
            return response()->json(['result' => $recordatorio],200);
          }
          catch (\Exception $e) {
              //echo $e->getMessage();
    ...
    public function destroy($id)
    {
        ...
        if ($recordatorio->active == false) {
            $recordatorio->active = true;
        } else {
            $recordatorio->active = false;
        }
        $recordatorio->save();
