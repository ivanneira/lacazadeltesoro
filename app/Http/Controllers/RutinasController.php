...
class RutinasController extends Controller
{
    ...
    public function list(Request $request)
    {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = "";
                        $btn .= '<a href="javascript:;" id="gridDetail" data-id="' . $row->id . '" class="btn btn-success btn-sm" title="entrar"><i class="fa fa-search "></i> </a>';
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            //     $rutina  = Rutinas::where($where)->first();
            //     $image = ($request->fotobase64 !="" ) ? $request->fotobase64 : $rutina->foto;
            // }
            // else
            // {
            ...
            DB::commit();
            return response()->json(['result' => $rutina],200);
          }
          catch (\Exception $e) {
              //echo $e->getMessage();
